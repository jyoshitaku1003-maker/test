...
import { getFoodByDate, getExerciseByDate, getWeightLog, todayStr } from '../utils/api';
...
export default function Dashboard({ profile, onTabChange }) {
  ...
  const p = profile && currentWeight ? { ...profile, weight: currentWeight } : null;
      ...
      <div className="card">
        ...
        <div className="progress-bar-wrap">
          <div className="progress-bar">
            <div className="progress-fill" style={{ width: `${progress}%`, background: progress > 100 ? '#F44336' : '#FF7043' }} />
          </div>
